...
namespace System.Net.Http
{
    ...
    public class HttpResult
    {
        ...
        public HttpResult(int code, string msg = null)
        {
            Code = code;
            Msg = msg ?? ((HttpStatusCode)(code > 1000 ? code - 1000 : code)).ToString();
        }

        public HttpResult(HttpStatusCode code, string msg = null)
        {
            Code = 1000 + (int)code;
        ...
        public static HttpResult<IEnumerable<HttpResult>> MultiStatus(IEnumerable<HttpResult> results, string msg = null) => new HttpResult<IEnumerable<HttpResult>>(HttpStatusCode_MultiStatus, msg, results);
        public static HttpResult<IEnumerable<HttpResult>> MultiStatus(string msg, params HttpResult[] results) => new HttpResult<IEnumerable<HttpResult>>(HttpStatusCode_MultiStatus, msg, results);
        public static HttpResult<IEnumerable<HttpResult>> MultiStatus(params HttpResult[] results) => new HttpResult<IEnumerable<HttpResult>>(HttpStatusCode_MultiStatus, null, results);
    ...
    public class HttpResult<T> : HttpResult
    {
        ...
        public HttpResult(int code, string msg, T data) : base(code, msg)
        {
            Data = data;
        }

        public HttpResult(HttpStatusCode code, string msg, T data) : base(code, msg)
        {
            Data = data;
        }
    }
